...
<body>
    ...
    <div class="header">
        <div>
            ...
            <p>Relatório de Ordens de Compra</p>
        </div>
    ...
    @php
        ...
        $valorAbertas  = $ordens->where('status', 'aberta')->sum('valor_total');
    @endphp
    ...
    <div class="resumo">
        ...
        <div class="resumo-card">
            <p>Valor em Aberto</p>
            <p style="color: #065F46;">R$ {{ number_format($valorAbertas, 2, ',', '.') }}</p>
        </div>
    </div>
        ...
        <tbody>
            @foreach($ordens as $item)
                <tr>
                    ...
                    <td>{{ $item->data_compra ? $item->data_compra->format('d/m/Y') : '-' }}</td>
                    <td>
